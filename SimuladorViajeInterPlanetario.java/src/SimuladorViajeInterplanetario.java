...
public class SimuladorViajeInterplanetario {
    ...
    static double mostrarProgreso = 0;
    static boolean iniciarSimulacion = false;
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            switch (opcion) {
                ...
                System.out.println("Creadores Codigo: Fabian Daza y Edwin Lozano");
                System.exit(0);
                    break;
                default:
    ...
    static void mostrarMenu() {
        System.out.println("\n==========================================================");
        System.out.println("******* Bienvenidos al Simulador Interplanetario ********");
        System.out.println("    ----- Creadores FABIAN DIAZ Y EDWIN LOZANO -----");
        System.out.println("==========================================================");
        System.out.println("\nMenú Principal:");
        if (!destinoSeleccionado) {
        ...
        System.out.println("Presiona ENTER para contiuar");
    }
    ...
    static void seleccionarNave() {
        ...
        String[] naves = {"Nave Apolo11 (Velocidad: 100,000 km/h)", "Nave Romulus(Velocidad: 200,000 km/h)"};
    ...
    static boolean validarRecursos(double[] recursosIntroducidos, double[] recursosNecesarios) {
        if (recursosIntroducidos[0] < recursosNecesarios[0] || recursosIntroducidos[1] < recursosNecesarios[1]) {
            System.out.println("¡Advertencia! No tienes suficientes recursos para completar el viaje.");
            return false;
        }
        return true;
    }
    ...
    static boolean simularViaje(double distancia, double tiempo, double[] recursos) {
        ...
        while (progreso < distancia) {
            ...
            //mostrar el progreso del viaje en forma de barra
            mostrarProgreso(progreso, distancia, combustible,oxígeno, estadoNave);
           
            // Mostrar progreso y recursos actuales
            double mostrarProgreso = (progreso / distancia) * 100;
    ...
    static void mostrarProgreso(double progreso, double distancia, double oxígeno, double danio, double estadoNave) {
        int progresoPorcentaje = (int) ((progreso / distancia) * 100);
        StringBuilder barra = new StringBuilder("[");
        for (int i = 0; i < 50; i++) {
            if (i < progresoPorcentaje / 2) barra.append("=");
            else barra.append(" ");
        }
        barra.append("] " + progresoPorcentaje + "%");
